...
- **METR's own follow-up (2026-02-24) is essential context, and it is widely misreported in both directions.** Two corrections to the common retellings, both checked against the primary post (https://metr.org/blog/2026-02-24-uplift-update/):
  - It is a study **redesign, not a retraction**. The July 2025 result stands: "Our early 2025 study found the use of AI causes tasks to take 19% longer, with a confidence interval between +2% and +39%."
  - **Mind the sign convention.** METR reports the late-2025 interim figures as a "speedup of **-18%** with a confidence interval between -38% and +9%" for returning developers and "-4%, with a confidence interval between -15% and +9%" for new ones. Because study 1's slowdown is stated as "19% longer", a *negative speedup is still a slowdown* — so the interim data points the same way as 2025, not the opposite way, and **both intervals cross zero**, making it inconclusive rather than a reversal.
  - Why they are redesigning: selection effects. Developers now decline to work without AI even at reduced pay ("we reduced the pay from $150/hr to $50/hr"), and "30% to 50% of developers told us that they were choosing not to submit some tasks because they did not want to do them without AI." METR calls the interim data only very weak evidence itself.
  - **So: anyone citing "AI makes devs 19% slower" as settled 2026 fact is over-claiming, and anyone citing a 2026 speedup has misread the sign.** An earlier revision of this brief made the second error.
